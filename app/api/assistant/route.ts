...
const POLLINATIONS_SYSTEM = [
  ...
  'Не ставь диагнозы и не назначай лекарства. При красных флагах здоровья отправляй к ветеринару срочно.',
...
function classifyQuestion(question: string) {
  if (/вакцин|привив|рвот|понос|кров|температ|болит|хром|вет|здоров|лекар/i.test(question)) return 'health_triage';
