...
function statusFor(code: string) {
  if (['INVALID_CANDIDATE_BATCH', 'CONFIRMATION_REQUIRED', 'PET_MISMATCH', 'INVALID_CANDIDATE_METRIC', 'INVALID_CANDIDATE_DIRECTION', 'INVALID_CANDIDATE_SOURCE', 'CONFIDENCE_TOO_LOW', 'INVALID_CANDIDATE_VALUE', 'INVALID_OBSERVED_AT', 'INVALID_ONSET_AT', 'INVALID_IDEMPOTENCY_KEY', 'CAPTURE_MISMATCH'].includes(code)) return 400;
