...
Псё — платформа для владельца собаки. Это цифровой ассистент по уходу, воспитанию, социализации и естественному развитию вместе с питомцем. Это среда для заботы о собаке и помощник для хозяина.

Псё:

- позволяет управлять знаниями о питомце, накапливать их и удобно визуализировать;
- напоминает и координирует среди дел, дат и нарушений привычек;
- помогает социализироваться с другими собаками;
- помогает сформировать безопасные маршруты для личного знания и публичных слоёв карт;
- сохраняет историю взаимодействия и даёт данные AI-ассистенту для сохранения контекста про питомца;
- создаёт знание о питомце для внешних пользователей: друзей, догситтеров, родственников, соседей, специалистов;
- позволяет формировать вишлисты и интеграции с производителями;
- даёт доступ к телемедицине партнёров, записи в ветклиники и красной кнопке на случай ЧП.
...
Платная версия Псё отличается от бесплатной функциональностью, а широкая версия продукта позволяет получить именной брелок, адресник или сувенир с персонализацией под собаку.
...
- я могу найти безопасное пространство и новых друзей для собаки;
- я могу описать маршрут и поделиться им с другом;
- я могу найти новых друзей и быть уверенным в счастье собаки.

Основной путь удержания:

- напоминания о запланированных делах и важных процедурах: осмотр, стрижка когтей, обработки, вакцинация, груминг, лекарства;
- возможность найти друзей и сделать прогулки безопаснее и интереснее;
- возможность делиться важной информацией с внешними людьми через красивые карточки, где пользователь управляет содержанием, а сама карточка ощущается как редкая коллекционная вещь и создаёт виральность;
- возможность найти клинику и pet-friendly места в своём районе или узнать чужие подходящие маршруты.

Итоговая пользовательская рамка:

- сделал профиль — получил возможность отслеживать динамику и прогресс;
- используешь профиль для знакомства с собаками рядом;
- используешь профиль для шеринга с внешними пользователями;
- исходя из профиля и привычек управляешь календарём напоминаний;
- советуешься с AI, а AI-агент может управлять привычками и напоминаниями через подтверждение владельца;
- исходя из темперамента ищешь подходящий публичный маршрут или делишься своим.
