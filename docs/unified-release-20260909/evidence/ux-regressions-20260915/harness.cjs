...
const out=__dirname;const base=process.env.BASE_URL||'http://127.0.0.1:3295';
async function setup(engine='chromium',width=390){
 ...
 const pet={id:'11111111-1111-4111-8111-111111111111',owner_id:'qa-owner',name:'Мята',life_stage:'взрослая',profile_version:0};
