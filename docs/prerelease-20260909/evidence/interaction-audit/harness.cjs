const {chromium,webkit}=require('/Users/ogoruslan/.openclaw/workspace/wt-pso-agent-20260908/node_modules/playwright');
const fs=require('node:fs/promises');
const out=__dirname;const base='http://127.0.0.1:3259';
async function setup(engine='chromium',width=390){
 ...
 const pet={id:'11111111-1111-4111-8111-111111111111',owner_id:'qa-owner',name:'Мята'};
