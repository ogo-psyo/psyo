-- Forward migration for databases that already applied 20260813170000.
-- Dog creation is independent from the optional first care task.
...
begin
  ...
  insert into public.onboarding_activations (
    ...
    p_owner_id, p_idempotency_key, p_request_fingerprint, v_pet.id, null
  );
